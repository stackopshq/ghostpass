...
const en: Dict = {
  ...
  "org.delete": "Delete",
  "org.deleteCollection": "Delete collection",
  "org.confirmDeleteCollection": "Delete the collection « {name} »? It must be empty.",
  "org.confirmDeleteItem": "Permanently delete « {name} » from this collection? Team items have no trash.",
  ...
  "app.sharedReadOnlyHere": "read-only — this password belongs to a team collection",
  "app.sharedEditElsewhere": "edit it from the Organisations screen — this view cannot write to a team",
...
const fr: Dict = {
  ...
  "org.deleteCollection": "Supprimer la collection",
  "org.confirmDeleteCollection": "Supprimer la collection « {name} » ? Elle doit être vide.",
  "org.confirmDeleteItem": "Supprimer définitivement « {name} » de cette collection ? Les éléments d'équipe n'ont pas de corbeille.",
  ...
  "app.sharedReadOnlyHere": "lecture seule — ce mot de passe appartient à une collection d'équipe",
  "app.sharedEditElsewhere": "à modifier depuis l'écran Organisations — cette vue n'écrit pas vers une équipe",
  ...
  "app.sharedItem": "Secret d'équipe",
...
// La langue detectee doit s'appliquer AU CHARGEMENT, pas seulement au premier
// clic : sans ceci, `document.documentElement.lang` resterait a la valeur
// ecrite dans index.html et mentirait des la premiere visite d'un anglophone.
