...
#ifndef GHOSTPASSAUTOFILL_SWIFT_H
#define GHOSTPASSAUTOFILL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GhostpassAutoFill",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17GhostpassAutoFill32CredentialProviderViewController")
...
/// <code>serviceIdentifiers</code> porte le ou les domaines du champ visé.
...
/// unique. Le pendant de <code>prepareCredentialList</code>, pour l’autre nature de secret.
