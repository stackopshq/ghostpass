...
const en: Dict = {
  ...
  "app.website": "Website",
  // Une entrée porte plusieurs adresses : `connect.example.com` et
  // `user.example.com` ouvrent le même compte. Le pluriel est donc le cas
  // normal, et le libellé le dit avant même qu'on ajoute la deuxième.
  "app.websites": "Websites",
  "app.websiteNumber": "Website {n}",
  "app.addWebsite": "Add an address",
  "app.removeWebsite": "Remove this address",
...
const fr: Dict = {
  ...
  "app.websites": "Sites web",
  "app.websiteNumber": "Site web {n}",
  "app.addWebsite": "Ajouter une adresse",
  "app.removeWebsite": "Retirer cette adresse",
