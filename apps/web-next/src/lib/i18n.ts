...
const en: Dict = {
  ...
  "app.sharesSub": "Links you have issued. Revoking one makes it unreadable immediately.",
  "app.revoke": "Revoke",
...
const fr: Dict = {
  ...
  "app.sharesSub": "Les liens que vous avez émis. En révoquer un le rend illisible immédiatement.",
  "app.revoke": "Révoquer",
